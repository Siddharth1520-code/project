    ...
    <div>
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 md:px-20">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            <NavLink
              ...
              to={"/"}
              className="mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-yellow-900 hover:bg-violet-500"
            >
              About Us
            </NavLink>
            <NavLink
      ...
      <footer>
        ...
        <p className="text-center py-1 bg-gray-200 text-gray-500 text-sm">
          Copyright © 2023 EarthKind. | All Rights Reserved
        </p>
      </footer>
    </div>
  );
